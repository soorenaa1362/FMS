    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="mb-4 text-center text-md-right">
                <h5 class="font-weight-bold">ویرایش اطلاعات خرجکرد</h5>
            </div>
            <hr>
            ...
            <form action="{{ route('costs.update', [$cost->id]) }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input class="form-control" id="title" name="title" type="text" value="{{ $cost->title }}">
                    </div>

                    <div class="form-group col-md-3">
                        <label for="amount">مبلغ</label>
                        <input type="text" name="amount" class="form-control" value="{{ $cost->amount }}">
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="dateInput"
                                name="date" value="{{ verta($cost->date)->format('Y/m/d') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="card_id" id="cardSelect" class="form-control" data-live-search="true">
                            @foreach ($cards as $card)
                                <option value="{{ $card->id }}" {{ $card->id == $cost->card->id ? 'selected' : '' }}>

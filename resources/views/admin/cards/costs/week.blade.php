    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
            <div class="d-flex flex-column flex-md-row text-center justify-content-md-between mb-4">
                <h5 class="font-weight-bold mb-3 mb-md-0">خرجکرد های این هفته کارت {{ $card->name }}</h5>
                <h6 class="font-weight-bold mb-3 mb-md-0">({{ $card->alias }})</h6>
                <h6 class="font-weight-bold">مجموع خرجکرد این هفته : {{ number_format($cash) }} تومان</h6>
